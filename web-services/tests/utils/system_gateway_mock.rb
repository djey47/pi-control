...
class SystemGatewayMock
  ...
  def ssh(host, user_name, *commands)
    ...
    raise 'No command specified' if commands.empty?
    ...
    if commands.size == 1
      ...
      case command
        ...
        when 'vim-cmd vmsvc/power.getstate 0'
          out = ''
        when 'vim-cmd vmsvc/power.on 1'
          out = "Powering on VM:\n"
        when 'vim-cmd vmsvc/power.on 0'
          out = ''
        when 'vim-cmd vmsvc/power.shutdown 1'
          out = ''
        when 'vim-cmd vmsvc/power.shutdown 0'
          out = ''
        when 'vim-cmd vmsvc/power.off 1'
          out = "Powering off VM:\n"
        when 'vim-cmd vmsvc/power.off 0'
          out = ''
    ...
    #Handles multiple commands
      ...
      chained_command = commands.join(';')

      case chained_command
        when 'esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST2000DL0032D9VT166__________________________________5YD1XA4F;esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST2000DL0032D9VT166__________________________________5YD2HWZ3'
          out = "Parameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,117,99,\nPower-on Hours,0,76,76,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,117,99,\nDrive Temperature,0,36,42,\nDriver Rated Max Temperature,45,64,58,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\nParameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,114,99,\nPower-on Hours,0,77,77,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,114,99,\nDrive Temperature,0,36,45,\nDriver Rated Max Temperature,45,64,55,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\n"
        when 'esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST2000DL0032D9VT166__________________________________5YD1XA4F;esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST2000DL0032D9VT166__________________________________5YD2HWZ3;esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST3000VN0002D1H4167__________________________________W300GKNA;esxcli --formatter=csv storage core device smart get -d t10.ATA_____ST3000VN0002D1H4167__________________________________W300H4CK;esxcli --formatter=csv storage core device smart get -d t10.ATA_____WDC_WD2500BEVT2D75ZCT2________________________WD2DWXH109031153'
          out = "Parameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,117,99,\nPower-on Hours,0,76,76,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,117,99,\nDrive Temperature,0,36,42,\nDriver Rated Max Temperature,45,64,58,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\nParameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,114,99,\nPower-on Hours,0,77,77,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,114,99,\nDrive Temperature,0,37,45,\nDriver Rated Max Temperature,45,64,55,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\nParameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,114,99,\nPower-on Hours,0,77,77,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,114,99,\nDrive Temperature,0,39,45,\nDriver Rated Max Temperature,45,64,55,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\nParameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,114,99,\nPower-on Hours,0,77,77,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,114,99,\nDrive Temperature,0,38,45,\nDriver Rated Max Temperature,45,64,55,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\nParameter,Threshold,Value,Worst,\nHealth Status,N/A,OK,N/A,\nMedia Wearout Indicator,N/A,N/A,N/A,\nWrite Error Count,N/A,N/A,N/A,\nRead Error Count,6,114,99,\nPower-on Hours,0,77,77,\nPower Cycle Count,20,100,100,\nReallocated Sector Count,36,100,100,\nRaw Read Error Rate,6,114,99,\nDrive Temperature,0,39,45,\nDriver Rated Max Temperature,45,64,55,\nWrite Sectors TOT Count,0,200,200,\nRead Sectors TOT Count,N/A,N/A,N/A,\nInitial Bad Block Count,99,100,100,\n-\n"
        else
          @verify = false
          raise "Unexpected chained commands: #{chained_command}"
      end
    end
    out
  end
